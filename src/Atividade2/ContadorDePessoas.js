            ...
            <div className="generos">
                <div className="genero">
                    ...
                    <div className="botoes">
                        <MyButton texto="+" tipo="mais" onClick={() => setHomens(homens + 1)} />
                        <MyButton texto="-" tipo="menos" onClick={() => homens > 0 && setHomens(homens - 1)} desabilitado={homens === 0} />
                    </div>
                    <p>Homens</p>
                ...
                <div className="genero">
                    ...
                    <div className="botoes">
                        <MyButton texto="+" tipo="mais" onClick={() => setMulheres(mulheres + 1)} />
                        <MyButton texto="-" tipo="menos" onClick={() => mulheres > 0 && setMulheres(mulheres - 1)} desabilitado={mulheres === 0} />
                    </div>
                    <p>Mulheres</p>
